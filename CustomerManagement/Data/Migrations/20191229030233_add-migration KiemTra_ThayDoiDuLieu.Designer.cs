...
namespace CustomerManagement.Data.Migrations
{
    ...
    [Migration("20191229030233_add-migration KiemTra_ThayDoiDuLieu")]
    partial class addmigrationKiemTra_ThayDoiDuLieu
    {
            ...
            modelBuilder.Entity("CustomerManagement.Models.Tea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8e411a4f-4787-40be-ac66-98976fc5f983"),
                            CreatedDate = new DateTime(2019, 12, 29, 3, 2, 32, 888, DateTimeKind.Utc).AddTicks(7007),
                            Name = "StrawberryTea",
                            Price = 50000.0,
                            Quantity = 150
                        },
                        new
                        {
                            Id = new Guid("78fc09bf-42f1-45b1-b165-afc472ce191a"),
                            CreatedDate = new DateTime(2019, 12, 29, 3, 2, 32, 889, DateTimeKind.Utc).AddTicks(7362),
                            Name = "PeachTea",
                            Price = 45000.0,
                            Quantity = 100
                        },
                        new
                        {
                            Id = new Guid("5833dcc0-03c1-4a10-81ac-40d21467c3b5"),
                            CreatedDate = new DateTime(2019, 12, 29, 3, 2, 32, 889, DateTimeKind.Utc).AddTicks(7477),
                            Name = "LycheeTea",
                            Price = 55000.0,
                            Quantity = 75
                        },
                        new
                        {
                            Id = new Guid("b89da4d2-5983-462f-baaf-52dc16e361c3"),
                            CreatedDate = new DateTime(2019, 12, 29, 3, 2, 32, 889, DateTimeKind.Utc).AddTicks(7505),
                            Name = "Test",
                            Price = 55000.0,
                            Quantity = 75
                        });
