...
namespace CustomerManagement.Data.Migrations
{
    ...
    [Migration("20191124070920_AddCarparkingEntity")]
    partial class AddCarparkingEntity
    {
            ...
            modelBuilder.Entity("CustomerManagement.Models.Tea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("48661a04-177b-43c1-aa1e-c0f09905eeba"),
                            CreatedDate = new DateTime(2019, 11, 24, 7, 9, 20, 446, DateTimeKind.Utc).AddTicks(1326),
                            Name = "StrawberryTea",
                            Price = 50000.0,
                            Quantity = 150
                        },
                        new
                        {
                            Id = new Guid("0ebbf7ff-3745-41f4-8581-27b67239bd81"),
                            CreatedDate = new DateTime(2019, 11, 24, 7, 9, 20, 448, DateTimeKind.Utc).AddTicks(2204),
                            Name = "PeachTea",
                            Price = 45000.0,
                            Quantity = 100
                        },
                        new
                        {
                            Id = new Guid("a5b28fac-29ac-4a88-aa87-3480a0a8f632"),
                            CreatedDate = new DateTime(2019, 11, 24, 7, 9, 20, 448, DateTimeKind.Utc).AddTicks(2361),
                            Name = "LycheeTea",
                            Price = 55000.0,
                            Quantity = 75
                        });
